...
describe('InstagramService', () => {
    let service;
    beforeEach(() => {
        service = new instagram_1.InstagramService();
        jest.clearAllMocks();
    });
    ...
    describe('getShortLivedToken', () => {
        it('should exchange code for short-lived token', async () => {
            ...
            expect(mockedAxios.post).toHaveBeenCalledWith('https://api.instagram.com/oauth/access_token', expect.objectContaining({
                code: 'auth-code-123',
    ...
    describe('getLongLivedToken', () => {
        it('should exchange short-lived token for long-lived token', async () => {
            ...
            expect(mockClient.get).toHaveBeenCalledWith('/access_token', expect.objectContaining({
    ...
    describe('getUserProfile', () => {
        it('should fetch user profile information', async () => {
            ...
            expect(mockClient.get).toHaveBeenCalledWith('/user-123', expect.objectContaining({
                params: expect.objectContaining({
    ...
    describe('getUserMedia', () => {
        it('should fetch user media/posts', async () => {
            ...
            expect(mockClient.get).toHaveBeenCalledWith('/user-123/media', expect.objectContaining({
                params: expect.objectContaining({
                    access_token: 'access-token',
                    limit: 25,
                }),
    ...
    describe('createMediaContainer', () => {
        it('should create a media container for image', async () => {
            ...
            service.client = mockClient;
            const result = await service.createMediaContainer('access-token', 'user-123', 'https://example.com/image.jpg', 'Test caption');
            expect(mockClient.post).toHaveBeenCalledWith('/user-123/media', null, expect.objectContaining({
                params: expect.objectContaining({
    ...
    describe('publishMedia', () => {
        it('should publish a media container', async () => {
            ...
            expect(mockClient.post).toHaveBeenCalledWith('/user-123/media_publish', null, expect.objectContaining({
                params: expect.objectContaining({
    ...
    describe('postContent', () => {
        it('should complete full post flow for image', async () => {
            ...
            service.client = mockClient;
            const result = await service.postContent('access-token', 'user-123', 'https://example.com/image.jpg', 'Test caption', false);
    ...
    describe('refreshLongLivedToken', () => {
        it('should refresh a long-lived token', async () => {
            ...
            expect(mockClient.get).toHaveBeenCalledWith('/refresh_access_token', expect.objectContaining({
                params: expect.objectContaining({

...
router.get('/creators', (_req, res, next) =>
...
router.get('/creators/:creatorId', (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.post('/creators', (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.post('/creators/:creatorId/portfolio', upload.single('file'), (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (!req.file) {
...
router.post('/creators/:creatorId/reviews', (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { creatorId } = req.params;
...
// Get all listings
router.get('/listings', (_req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      if (!creatorId || !title || !description || !price) {
        return next(
          new AppError_1.default('creatorId, title, description, and price are required', 400),
        );
      }
...
router.get('/listings/:listingId', (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {

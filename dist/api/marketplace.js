...
router.get('/creators', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.post('/creators', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield config_1.db.collection('creators').doc(userId).set({
            portfolio: portfolio || [],
            skills: skills || [],
            rating: rating || 0,
        });
...
router.post('/creators/:creatorId/reviews', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const reviewsSnapshot = yield config_1.db.collection('reviews').where('creatorId', '==', creatorId).get();
        let totalRating = 0;
...
// Get all listings
router.get('/listings', (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {

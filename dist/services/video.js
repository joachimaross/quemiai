...
const detectLabelsInVideo = (gcsUri) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const annotations =
      (_a = operationResult.annotationResults) === null || _a === void 0 ? void 0 : _a[0];
    const shotLabels =
      (_b =
        annotations === null || annotations === void 0
          ? void 0
          : annotations.shotLabelAnnotations) === null || _b === void 0
        ? void 0
        : _b
            .map((shotLabel) => {
              var _a;
              return (_a = shotLabel.annotations) === null || _a === void 0
                ? void 0
                : _a.map((annotation) => annotation.description);
            })
            .flat();
    return shotLabels;
  });
